...
| `Worksie/README.md`                               | Docs                       | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/dataset/worksie_training_schema.jsonl`   | Training schema            | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/prompts/prompt_deployment_trigger.md`    | Agent prompt               | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/prompts/prompt_blueprint_mapper.md`      | Agent prompt               | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/prompts/prompt_training_orchestrator.md` | Agent prompt               | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/prompts/prompt_ui_designer.md`           | Agent prompt               | Rewrite now        | Done in this branch.                                                                   |
| `Worksie/docs/worksie_folder_structure.txt`       | Layout reference           | Rewrite now        | Done in this branch.                                                                   |
...
- New canonical docs land in `Worksie/docs/`.
...
> Read `Worksie/docs/WORKSIE_SPINE.md`, `TECH_STACK_DECISION.md`,
