...
CREATE TABLE "Invoice" (
  ...
  CONSTRAINT "Invoice_billingBatch_fkey" FOREIGN KEY ("organizationId", "billingBatchId") REFERENCES "WeeklyBillingBatch" ("organizationId", "id") ON DELETE RESTRICT ON UPDATE CASCADE
);
